...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'popover',
                loadChildren: () => __webpack_require__.e(/*! import() | popover-popover-module */ "popover-popover-module").then(__webpack_require__.bind(null, /*! ../popover/popover.module */ "./src/app/pages/popover/popover.module.ts")).then(m => m.PopoverPageModule)
            },
            {
                path: '',
